...
DB_CONFIG = {
    ...
    "user": __import__("os").getenv("DB_USER"),
    "password": __import__("os").getenv("DB_PASSWORD"),
    "dbname": __import__("os").getenv("DB_NAME"),
}
...
def check_pricing_feeds() -> CheckResult:
    ...
    ~23% (surjections(5,4)/4^5), meaning this check failed by pure
    chance ~77% of the time even when the system was fully healthy.
